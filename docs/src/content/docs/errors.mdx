---
title: "Errors"
description: "Map Rust Result<T, E> into native error handling in Swift, Kotlin, Java, C#, and TypeScript with BoltFFI using string errors and structured error types."
---
