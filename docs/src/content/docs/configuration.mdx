---
title: "Configuration"
description: "Configure boltffi.toml package names, target outputs, and platform packaging behavior for generated Swift, Kotlin, Java, TypeScript, and Python bindings."
---
